...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100;200;300;400;500;600;700;800&display=swap" rel="stylesheet">
 	...
 	<link rel="stylesheet" href="css/inputText.css" type="text/css" media="screen" />
...
<body>
	...
	<!-- 영수증 스캔 결과 폼 -->
	<form name="form1" method="post" action="" enctype="multipart/form-data"  style="text-align: center; ">
